...
}).AddInMemoryIdentityResources(IdentityConfiguration.identityResources).AddInMemoryClients(IdentityConfiguration.clients).AddAspNetIdentity<ApplicationUser>().AddDeveloperSigningCredential();
